...
class arch_sh2(generic_sh):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -m2 -pipe"
...
class arch_sh2a(generic_sh):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -m2a -pipe"
...
class arch_sh3(generic_sh):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -m3 -pipe"
...
class arch_sh4(generic_sh):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -m4 -pipe"
...
class arch_sh4a(generic_sh):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -m4a -pipe"
