...
class arch_mips1(generic_mips):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips1 -mabi=32 -mplt -pipe"
...
class arch_mips2(generic_mips):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips2 -mabi=32 -mplt -pipe"
...
class arch_mips32(generic_mips):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips32 -mabi=32 -mplt -pipe"
...
class arch_mips32r2(generic_mips):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips32r2 -mabi=32 -mplt -pipe"
...
class arch_mips3(generic_mips):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips3 -mabi=32 -mplt -mfix-r4000 -mfix-r4400 -pipe"
...
class arch_mips3_n32(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips3 -mabi=n32 -mplt -mfix-r4000 -mfix-r4400 -pipe"
...
class arch_mips3_n64(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips3 -mabi=64 -mfix-r4000 -mfix-r4400 -pipe"
...
class arch_mips3_multilib(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips3 -mplt -mfix-r4000 -mfix-r4400 -pipe"
...
class arch_mips4(generic_mips):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips4 -mabi=32 -mplt -pipe"
...
class arch_mips4_n32(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips4 -mabi=n32 -mplt -pipe"
...
class arch_mips4_n64(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips4 -mabi=64 -pipe"
...
class arch_mips4_multilib(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips4 -mplt -pipe"
...
class arch_mips4_r10k(generic_mips):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=r10k -mabi=32 -mplt -pipe"
...
class arch_mips4_r10k_n32(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=r10k -mabi=n32 -mplt -pipe"
...
class arch_mips4_r10k_n64(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=r10k -mabi=64 -pipe"
...
class arch_mips4_r10k_multilib(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=r10k -mplt -pipe"
...
class arch_mips4_r12k(generic_mips):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=r12k -mno-fix-r10000 -mabi=32 -mplt -pipe"
...
class arch_mips4_r12k_n32(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=r12k -mno-fix-r10000 -mabi=n32 -mplt -pipe"
...
class arch_mips4_r12k_n64(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=r12k -mno-fix-r10000 -mabi=64 -pipe"
...
class arch_mips4_r12k_multilib(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=r12k -mno-fix-r10000 -mplt -pipe"
...
class arch_mips64(generic_mips):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips64 -mabi=32 -mplt -pipe"
...
class arch_mips64_n32(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips64 -mabi=n32 -mplt -pipe"
...
class arch_mips64_n64(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips64 -mabi=64 -pipe"
...
class arch_mips64_multilib(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips64 -mplt -pipe"
...
class arch_mips64r2(generic_mips):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips64r2 -mabi=32 -mplt -pipe"
...
class arch_mips64r2_n32(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips64r2 -mabi=n32 -mplt -pipe"
...
class arch_mips64r2_n64(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips64r2 -mabi=64 -pipe"
...
class arch_mips64r2_multilib(generic_mips64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips64r2 -mplt -pipe"
...
class arch_mipsel3(generic_mipsel):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips3 -mabi=32 -mplt -Wa,-mfix-loongson2f-nop -pipe"
...
class arch_mipsel3_n32(generic_mips64el):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips3 -mabi=n32 -mplt -Wa,-mfix-loongson2f-nop -pipe"
...
class arch_mipsel3_n64(generic_mips64el):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips3 -mabi=64 -Wa,-mfix-loongson2f-nop -pipe"
...
class arch_mipsel3_multilib(generic_mips64el):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=mips3 -mplt -Wa,-mfix-loongson2f-nop -pipe"
...
class arch_loongson2e(generic_mipsel):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=loongson2e -mabi=32 -mplt -pipe"
...
class arch_loongson2e_n32(generic_mips64el):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=loongson2e -mabi=n32 -mplt -pipe"
...
class arch_loongson2e_n64(generic_mips64el):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=loongson2e -mabi=64 -pipe"
...
class arch_loongson2e_multilib(generic_mips64el):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=loongson2e -mplt -pipe"
...
class arch_loongson2f(generic_mipsel):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=loongson2f -mabi=32 -mplt -Wa,-mfix-loongson2f-nop -pipe"
...
class arch_loongson2f_n32(generic_mips64el):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=loongson2f -mabi=n32 -mplt -Wa,-mfix-loongson2f-nop -pipe"
...
class arch_loongson2f_n64(generic_mips64el):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=loongson2f -mabi=64 -Wa,-mfix-loongson2f-nop -pipe"
...
class arch_loongson2f_multilib(generic_mips64el):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=loongson2f -mplt -Wa,-mfix-loongson2f-nop -pipe"
...
class arch_loongson3a(generic_mipsel):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=loongson3a -mabi=32 -mplt -pipe"
...
class arch_loongson3a_n32(generic_mips64el):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=loongson3a -mabi=n32 -mplt -pipe"
...
class arch_loongson3a_n64(generic_mips64el):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=loongson3a -mabi=64 -pipe"
...
class arch_loongson3a_multilib(generic_mips64el):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=loongson3a -mplt -pipe"
...
class arch_cobalt(generic_mipsel):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=r5000 -mabi=32 -mplt -pipe"
...
class arch_cobalt_n32(generic_mips64el):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=r5000 -mabi=n32 -mplt -pipe"
		self.settings["HOSTUSE"]=["cobalt"]
