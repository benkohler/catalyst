...
class arch_ppc(generic_ppc):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -mcpu=powerpc -mtune=powerpc -pipe"
...
class arch_970(arch_ppc64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -pipe -mcpu=970 -mtune=970"
...
class arch_cell(arch_ppc64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -pipe -mcpu=cell -mtune=cell"
...
class arch_g3(generic_ppc):
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -mcpu=G3 -mtune=G3 -pipe"
...
class arch_g4(generic_ppc):
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -mcpu=G4 -mtune=G4 -maltivec -mabi=altivec -pipe"
		self.settings["HOSTUSE"]=["altivec"]
...
class arch_g5(generic_ppc):
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -mcpu=G5 -mtune=G5 -maltivec -mabi=altivec -pipe"
		self.settings["HOSTUSE"]=["altivec"]
...
class arch_power(generic_ppc):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -mcpu=power -mtune=power -pipe"
...
class arch_power_ppc(generic_ppc):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -mcpu=common -mtune=common -pipe"
...
class arch_power6(arch_ppc64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -pipe -mcpu=power6 -mtune=power6"
		self.settings["HOSTUSE"]=["altivec","ibm"]
...
class arch_power7(arch_ppc64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -pipe -mcpu=power7 -mtune=power7 -mabi=elfv2"
		self.settings["HOSTUSE"]=["altivec","ibm"]
...
class arch_power8(arch_ppc64):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -pipe -mcpu=power8 -mtune=power8 -mabi=elfv2"
		self.settings["HOSTUSE"]=["altivec","ibm"]
