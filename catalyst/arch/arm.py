...
class arch_armv4l(generic_arm):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]+=" -march=armv4"
...
class arch_armv4tl(generic_arm):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]+=" -march=armv4t"
...
class arch_armv5tl(generic_arm):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]+=" -march=armv5t"
...
class arch_armv5tel(generic_arm):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]+=" -march=armv5te"
...
class arch_armv6j(generic_arm):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]+=" -march=armv6j -mfpu=vfp -mfloat-abi=softfp"
...
class arch_armv6z(generic_arm):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]+=" -march=armv6z -mfpu=vfp -mfloat-abi=softfp"
...
class arch_armv6zk(generic_arm):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]+=" -march=armv6zk -mfpu=vfp -mfloat-abi=softfp"
...
class arch_armv7a(generic_arm):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]+=" -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp"
...
class arch_armv6j_hardfp(generic_arm):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]+=" -march=armv6j -mfpu=vfp -mfloat-abi=hard"
...
class arch_armv7a_hardfp(generic_arm):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]+=" -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=hard"
...
class arch_armv5teb(generic_armeb):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]+=" -mcpu=xscale"
