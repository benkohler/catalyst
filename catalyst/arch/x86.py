...
class arch_x86(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -mtune=i686 -pipe"
...
class arch_i386(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=i386 -pipe"
		self.settings["CHOST"]="i386-pc-linux-gnu"
...
class arch_i486(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=i486 -pipe"
...
class arch_i586(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=i586 -pipe"
...
class arch_i686(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=i686 -pipe"
...
class arch_pentium_mmx(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=pentium-mmx -pipe"
...
class arch_pentium2(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=pentium2 -pipe"
		self.settings["HOSTUSEEXPAND"]={"CPU_FLAGS_X86":["mmx"]}
...
class arch_pentium3(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=pentium3 -pipe"
...
class arch_pentium4(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=pentium4 -pipe"
...
class arch_pentium_m(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=pentium-m -pipe"
		#self.settings["HOSTUSEEXPAND"]={"CPU_FLAGS_X86":["mmx","sse","sse2"]}
...
class arch_prescott(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=prescott -pipe"
		#self.settings["HOSTUSEEXPAND"]={"CPU_FLAGS_X86":["mmx","sse","sse2"]}
...
class arch_k6(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=k6 -pipe"
		self.settings["HOSTUSEEXPAND"]={"CPU_FLAGS_X86":["mmx"]}
...
class arch_k6_2(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=k6-2 -pipe"
...
class arch_athlon(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=athlon -pipe"
		self.settings["HOSTUSEEXPAND"]={"CPU_FLAGS_X86":["mmx","3dnow"]}
...
class arch_athlon_xp(generic_x86):
	...
	def __init__(self,myspec):
		...
		self.settings["CXXFLAGS"]="-O2 -march=athlon-xp -pipe"
